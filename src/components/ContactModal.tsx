    ...
    >
      <div className="relative mt-6 w-full max-w-295 sm:mt-0">
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute -top-11 right-0 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white text-black shadow-lg transition-colors hover:bg-white/90 sm:-top-3 sm:-right-3"
        >
