          ...
          <div>
            <div className="flex h-76.5 w-60 flex-col gap-3 rounded-2xl border-[0.2px] border-white/10 bg-white/3 px-3.5 py-2.5 backdrop-blur-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-white">Resort Type</div>
                  <div className="text-sm text-white/50">Select your dream resort</div>
                </div>
              </div>
            ...
            <div className="mt-6 flex h-62 w-60 flex-col gap-3 rounded-2xl border-[0.2px] border-white/10 bg-white/3 px-3.5 py-2.5 backdrop-blur-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-white">The Experience</div>
                  <div className="text-sm text-white/50">Select your fav view</div>
                </div>
              </div>
          ...
          <div className="relative">
            <div className="flex items-center gap-5">
              ...
              <div className="hidden shrink-0 flex-col items-center gap-3 lg:flex">
                <span
                  className="rounded-full border border-emerald-500/40 bg-emerald-500/10 px-2 py-3 text-[11px] font-semibold tracking-widest text-emerald-400"
